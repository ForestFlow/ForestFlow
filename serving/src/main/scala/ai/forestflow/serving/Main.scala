 ...
 */
package ai.forestflow.serving

import _root_.akka.actor.ActorSystem
import ai.forestflow.serving.cluster.{ServableProxy, ServableRegistry}
import ai.forestflow.serving.restapi.HTTPServer
import ai.forestflow.event.subscribers.PredictionLogger
import ai.forestflow.serving.cluster.{ServableProxy, ServableRegistry}
import ai.forestflow.startup.ClusterNodeStartup
import ai.forestflow.startup.ActorSystemStartup.system.log
...
object Main extends ClusterNodeStartup {
  ...
  override def postStartup(implicit system: ActorSystem, config: Config): Unit = {
    import ai.forestflow.startup.ActorSystemStartup.{cluster, shutdown}
